...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-eco-green-50 dark:bg-eco-green-900/20">
      {/* Navigation Buttons */}
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <Link to="/">
              <Button className="bg-eco-green-600 hover:bg-eco-green-700 text-white w-full sm:w-auto">
