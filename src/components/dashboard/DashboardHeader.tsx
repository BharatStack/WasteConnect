          ...
          <div className="flex items-center space-x-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56 bg-white border border-gray-200" align="end" forceMount>
                <DropdownMenuItem className="flex items-center text-gray-700 hover:bg-gray-100">
                ...
                <DropdownMenuItem onClick={handleSignOut} className="flex items-center text-gray-700 hover:bg-gray-100">
