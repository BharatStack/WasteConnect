...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white dark:bg-eco-green-900/90 shadow-sm backdrop-filter backdrop-blur-md bg-opacity-90">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/about" className="text-eco-green-600 dark:text-eco-green-300 hover:text-eco-green-800 dark:hover:text-white transition-colors">
              About
            </Link>
          </nav>
          ...
          <div className="md:hidden flex items-center">
            <Button 
              ...
              size="icon" 
              onClick={toggleMenu}
              className="text-eco-green-700 dark:text-white"
            >
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-center justify-between pt-2 px-4">
                <Button 
                  ...
                  size="sm"
                  onClick={toggleTheme}
                  className="rounded-full text-eco-green-700 dark:text-white"
                >
                  {isDark ? <Sun className="h-5 w-5" /> : <Moon className="h-5 w-5" />}
